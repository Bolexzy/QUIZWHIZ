            ...
            <div>
              <h2>
                <AccordionButton
                  bg="revert-layer"
                  color="royalblue"
                  _expanded={{ bg: 'black', opacity: 0.3, color: 'white' }}
                >
                      ...
                      <>
                        {
                          <>
                            ...
                            <Container>{formValues.description}</Container>
                          </>
                        }
                      </>
                    )}
              ...
              <AccordionPanel pb={4} style={{ width: '100%' }}>
                <div className="header-container" style={{ width: '100%' }}>
                  <form onSubmit={handleQuziDetailsFormSubmit}>
                    ...
                    <div className="form-row">
                      <label htmlFor="allotted_time_in_mins">
                        allotted Time (mins):
                      </label>
                      <input
                        type="number"
                    ...
                    <div className="form-row">
                      <label htmlFor="quiz_start_datetime">
                    ...
                    <Flex>
                      <Button colorScheme="red" onClick={deleteQuiz}>
                        delete quiz
                      </Button>
                      <button
                        className="ms-2 p-2 btn btn-secondary"
                        type="submit"
                      >
                        Submit
                      </button>
